...
class Project(models.NodeModel):
	...
	image = models.URLProperty(null=True,help_text=u'The URL (starting with http://) where the image is hosted.',verbose_name=u'Image URL')
	name = models.StringProperty(null=True,help_text=u'')
	_author = models.Relationship(User,null=True,rel_type='project_project_has_admin_author+',help_text=u'People that edited this entity.')
	partner = models.Relationship("Organization",null=True,rel_type='project_has_partner+',help_text=u'An entity can have Partners, i.e. Organizations that help without making a financial contribution (if financial or substancial help is involved, use Fundraising Round instead).')
	commentary = models.Relationship("Commentary",null=True,rel_type='project_has_commentary+',help_text=u'A Commentary is an article, a blog post or a report that assesses the quality of the Project.')
	activity_in_country = models.Relationship("Country",null=True,rel_type='project_has_activity_in_country+',help_text=u'The list of countries or territories the entity is active in. ')
	owner = models.Relationship("Organization",null=True,rel_type='project_has_owner+',help_text=u'The formal Owner of the entity.')
