...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TopicToken'
        db.create_table(u'detective_topictoken', (
            ...
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=None, auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'detective', ['TopicToken'])


    def backwards(self, orm):
        # Deleting model 'TopicToken'
        db.delete_table(u'detective_topictoken')
