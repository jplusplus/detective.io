...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopicToken.email'
        db.add_column(u'detective_topictoken', 'email',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True),
                      keep_default=False)


        # Changing field 'TopicToken.token'
        db.alter_column(u'detective_topictoken', 'token', self.gf('django.db.models.fields.CharField')(max_length=32))
        # Adding unique constraint on 'TopicToken', fields ['topic', 'email']
        db.create_unique(u'detective_topictoken', ['topic_id', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'TopicToken', fields ['topic', 'email']
        db.delete_unique(u'detective_topictoken', ['topic_id', 'email'])

        # Deleting field 'TopicToken.email'
        db.delete_column(u'detective_topictoken', 'email')


        # Changing field 'TopicToken.token'
        db.alter_column(u'detective_topictoken', 'token', self.gf('django.db.models.fields.CharField')(max_length=25))
