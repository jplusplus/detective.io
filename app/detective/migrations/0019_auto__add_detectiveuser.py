...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DetectiveProfileUser'
        db.create_table(u'detective_detectiveprofileuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('plan', self.gf('django.db.models.fields.CharField')(default='free', max_length=10)),
        ))
        db.send_create_signal(u'detective', ['DetectiveProfileUser'])


    def backwards(self, orm):
        # Deleting model 'DetectiveProfileUser'
        db.delete_table(u'detective_detectiveprofileuser')
