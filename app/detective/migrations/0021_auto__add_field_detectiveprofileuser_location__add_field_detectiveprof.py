...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetectiveProfileUser.location'
        db.add_column(u'detective_detectiveprofileuser', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'DetectiveProfileUser.organization'
        db.add_column(u'detective_detectiveprofileuser', 'organization',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'DetectiveProfileUser.url'
        db.add_column(u'detective_detectiveprofileuser', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetectiveProfileUser.location'
        db.delete_column(u'detective_detectiveprofileuser', 'location')

        # Deleting field 'DetectiveProfileUser.organization'
        db.delete_column(u'detective_detectiveprofileuser', 'organization')

        # Deleting field 'DetectiveProfileUser.url'
        db.delete_column(u'detective_detectiveprofileuser', 'url')
