...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.contributor_group'
        db.add_column(u'detective_topic', 'contributor_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.contributor_group'
        db.delete_column(u'detective_topic', 'contributor_group_id')
