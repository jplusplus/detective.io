...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'detective_topic', ['slug'])

        # Adding unique constraint on 'Topic', fields ['author', 'slug']
        db.create_unique(u'detective_topic', ['author_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Topic', fields ['author', 'slug']
        db.delete_unique(u'detective_topic', ['author_id', 'slug'])

        # Adding unique constraint on 'Topic', fields ['slug']
        db.create_unique(u'detective_topic', ['slug'])
    ...
    models = {
        ...
        u'detective.topic': {
            'Meta': {'unique_together': "(('author', 'slug'),)", 'object_name': 'Topic'},
