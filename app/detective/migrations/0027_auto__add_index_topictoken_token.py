...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TopicToken', fields ['token']
        db.create_index(u'detective_topictoken', ['token'])


    def backwards(self, orm):
        # Removing index on 'TopicToken', fields ['token']
        db.delete_index(u'detective_topictoken', ['token'])
