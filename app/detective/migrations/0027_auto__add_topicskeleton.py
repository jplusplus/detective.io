...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TopicSkeleton'
        db.create_table(u'detective_topicskeleton', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('picture_credits', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('ontology', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
            ('target_plans', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'detective', ['TopicSkeleton'])


    def backwards(self, orm):
        # Deleting model 'TopicSkeleton'
        db.delete_table(u'detective_topicskeleton')
