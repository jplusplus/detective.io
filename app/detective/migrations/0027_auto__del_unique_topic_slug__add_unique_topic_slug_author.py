...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Topic', fields ['slug', 'author']
        db.create_unique(u'detective_topic', ['slug', 'author_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Topic', fields ['slug', 'author']
        db.delete_unique(u'detective_topic', ['slug', 'author_id'])
