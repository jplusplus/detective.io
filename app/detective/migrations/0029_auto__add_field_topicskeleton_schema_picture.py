...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopicSkeleton.schema_picture'
        db.add_column(u'detective_topicskeleton', 'schema_picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopicSkeleton.schema_picture'
        db.delete_column(u'detective_topicskeleton', 'schema_picture')
