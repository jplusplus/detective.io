...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for topic in orm.Topic.objects.filter(skeleton_title__in=[u'Custom', 'No skeleton']):
            topic.skeleton_title = None
            topic.save()

    def backwards(self, orm):
        for topic in orm.Topic.objects.filter(skeleton_title=None):
            topic.skeleton_title = u'Custom'
            topic.save()
