...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TopicSkeleton.target_plans'
        db.alter_column(u'detective_topicskeleton', 'target_plans', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'TopicSkeleton.target_plans'
        db.alter_column(u'detective_topicskeleton', 'target_plans', self.gf('django.db.models.fields.CharField')(max_length=50))
