...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopicSkeleton.tutorial_link'
        db.add_column(u'detective_topicskeleton', 'tutorial_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopicSkeleton.tutorial_link'
        db.delete_column(u'detective_topicskeleton', 'tutorial_link')
