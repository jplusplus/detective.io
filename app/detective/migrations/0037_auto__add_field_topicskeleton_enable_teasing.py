...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopicSkeleton.enable_teasing'
        db.add_column(u'detective_topicskeleton', 'enable_teasing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopicSkeleton.enable_teasing'
        db.delete_column(u'detective_topicskeleton', 'enable_teasing')
