...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TopicDataSet'
        db.create_table(u'detective_topicdataset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('description', self.gf('tinymce.models.HTMLField')(null=True, blank=True)),
            ('picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('target_plans', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal(u'detective', ['TopicDataSet'])

        # Adding M2M table for field target_skeletons on 'TopicDataSet'
        m2m_table_name = db.shorten_name(u'detective_topicdataset_target_skeletons')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('topicdataset', models.ForeignKey(orm[u'detective.topicdataset'], null=False)),
            ('topicskeleton', models.ForeignKey(orm[u'detective.topicskeleton'], null=False))
        ))
        db.create_unique(m2m_table_name, ['topicdataset_id', 'topicskeleton_id'])


    def backwards(self, orm):
        # Deleting model 'TopicDataSet'
        db.delete_table(u'detective_topicdataset')

        # Removing M2M table for field target_skeletons on 'TopicDataSet'
        db.delete_table(db.shorten_name(u'detective_topicdataset_target_skeletons'))
    ...
    models = {
        ...
        u'detective.topicdataset': {
            ...
            'target_skeletons': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['detective.TopicSkeleton']", 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
