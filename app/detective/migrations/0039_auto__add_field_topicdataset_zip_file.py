...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopicDataSet.zip_file'
        db.add_column(u'detective_topicdataset', 'zip_file',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopicDataSet.zip_file'
        db.delete_column(u'detective_topicdataset', 'zip_file')
