...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TopicDataSet.zip_file'
        db.alter_column(u'detective_topicdataset', 'zip_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'TopicDataSet.zip_file'
        db.alter_column(u'detective_topicdataset', 'zip_file', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
