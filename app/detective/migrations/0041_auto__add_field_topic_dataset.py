...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.dataset'
        db.add_column(u'detective_topic', 'dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['detective.TopicDataSet'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.dataset'
        db.delete_column(u'detective_topic', 'dataset_id')
