...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.administrator_group'
        db.add_column(u'detective_topic', 'administrator_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='admin_topic', null=True, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.administrator_group'
        db.delete_column(u'detective_topic', 'administrator_group_id')
