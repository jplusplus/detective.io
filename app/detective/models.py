...
class Commentary(models.NodeModel):
	...
	_author = models.Relationship(User,null=True,rel_type='commentary_commentary_has_admin_author+',help_text=u'People that edited this entity.')
	author = models.Relationship("Person",null=True,rel_type='commentary_has_author+',help_text=u'The author or authors of the document.')
