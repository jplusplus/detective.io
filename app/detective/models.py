...
class Person(models.NodeModel):
	...
	_status = models.IntegerProperty(null=True,help_text=u'',verbose_name=u'status')
	name = models.StringProperty(null=True,help_text=u'')
	position = models.URLProperty(null=True,help_text=u'Current position within the Organization (e.g. CEO, CFO, spokesperson etc.)',verbose_name=u'Position')
...
class Organization(models.NodeModel):
	...
	organization_type = models.StringProperty(null=True,help_text=u'Type of organization. Can be Company, Government Organization, International Organization or NGO',verbose_name=u'Organization type')
	image = models.URLProperty(null=True,help_text=u'The URL (starting with http://) where the image is hosted.',verbose_name=u'Image URL')
	name = models.StringProperty(null=True,help_text=u'')
