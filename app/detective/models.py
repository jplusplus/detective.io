...
class Country(models.NodeModel):
	...
	_author = models.Relationship(User,null=True,rel_type='country_country_has_admin_author+',help_text=u'People that edited this entity.')
...
class Project(models.NodeModel):
	...
	source = models.URLProperty(null=True,help_text=u'The URL (starting with http://) to your source. If the source is a book, enter the URL to the book at Google Books or Amazon.',verbose_name=u'Source')
	image = models.URLProperty(null=True,help_text=u'The URL (starting with http://) where the image is hosted.',verbose_name=u'Image URL')
	_author = models.Relationship(User,null=True,rel_type='project_project_has_admin_author+',help_text=u'People that edited this entity.',verbose_name=u'author')
	...
	activity_in_country = models.Relationship("Country",null=True,rel_type='project_has_activity_in_country+',help_text=u'The list of countries or territories the entity is active in. ',verbose_name=u'Active in countries')
...
class EnergyProject(models.NodeModel):
	...
	source = models.URLProperty(null=True,help_text=u'The URL (starting with http://) to your source. If the source is a book, enter the URL to the book at Google Books or Amazon.',verbose_name=u'Source')
	image = models.URLProperty(null=True,help_text=u'The URL (starting with http://) where the image is hosted.',verbose_name=u'Image URL')
	_author = models.Relationship(User,null=True,rel_type='energy_project_energy_project_has_admin_author+',help_text=u'People that edited this entity.',verbose_name=u'author')
	...
	commentary = models.Relationship("Commentary",null=True,rel_type='energy_project_has_commentary+',help_text=u'A Commentary is an article, a blog post or a report that assesses the quality of the Project.',verbose_name=u'Commentary')
	activity_in_country = models.Relationship("Country",null=True,rel_type='energy_project_has_activity_in_country+',help_text=u'The list of countries or territories the entity is active in. ',verbose_name=u'Active in countries')
	partner = models.Relationship("Organization",null=True,rel_type='energy_project_has_partner+',help_text=u'An entity can have Partners, i.e. Organizations that help without making a financial contribution (if financial or substancial help is involved, use Fundraising Round instead).',verbose_name=u'Partner')
	owner = models.Relationship("Organization",null=True,rel_type='energy_project_has_owner+',help_text=u'The formal Owner of the entity.',verbose_name=u'Owner')

	class Meta:
		verbose_name = u'Energy project'
		verbose_name_plural = u'Energy projects'

class InternationalOrganization(models.NodeModel):
	_parent = u'Organization'
	_description = u'An International Organization is a transnational body with links to governments, whose primary goal is usually not to turn in a profit. Examples of International Organizations include the World Bank, the United Nations and its agencies etc.'
	_status = models.IntegerProperty(null=True,help_text=u'',verbose_name=u'status')
	source = models.URLProperty(null=True,help_text=u'The URL (starting with http://) to your source. If the source is a book, enter the URL to the book at Google Books or Amazon.',verbose_name=u'Source')
	website_url = models.URLProperty(null=True,help_text=u'',verbose_name=u'Website URL')
	name = models.StringProperty(null=True,help_text=u'')
	...
	office_address = models.StringProperty(null=True,help_text=u'The address or addresses where this organization does business. Do add the country at the end of the address, e.g. Grimmstraße 10A, 10967 Berlin, Germany.',verbose_name=u'Office address')
	address = models.StringProperty(null=True,help_text=u'The official address of the organization.',verbose_name=u'Address')
	_author = models.Relationship(User,null=True,rel_type='international_organization_international_organization_has_admin_author+',help_text=u'People that edited this entity.',verbose_name=u'author')
	revenue = models.Relationship("Revenue",null=True,rel_type='international_organization_has_revenue+',help_text=u'A Revenue represents the quantity of cash that the Organization was able to gather in any given year. It doesn\'t have to be equal to the net sales but can take into account subsidies as well.',verbose_name=u'Revenue')
	adviser = models.Relationship("Person",null=True,rel_type='international_organization_has_adviser+',help_text=u'The list of persons that help the entity.',verbose_name=u'Adviser')
	litigation_against = models.Relationship("self",null=True,rel_type='international_organization_has_litigation_against+',help_text=u'An entity is said to litigate against another when it is involved in a lawsuit or an out-of-court settlement with the other.',verbose_name=u'Litigation against')
	fundraising_round = models.Relationship("FundraisingRound",null=True,rel_type='international_organization_has_fundraising_round+',help_text=u'A Fundraising Round represents an event when an Organization was able to raise cash or another asset.',verbose_name=u'Fundraising round')
	partner = models.Relationship("self",null=True,rel_type='international_organization_has_partner+',help_text=u'An entity can have Partners, i.e. Organizations that help without making a financial contribution (if financial or substancial help is involved, use Fundraising Round instead).',verbose_name=u'Partner')
	board_member = models.Relationship("Person",null=True,rel_type='international_organization_has_board_member+',help_text=u'The list of board members of the Organization, if any.',verbose_name=u'Board member')
...
class Company(models.NodeModel):
	_parent = u'Organization'
	_description = u'A Company is an Organization whose primary goal is to break even or make a profit. It can be a corporation, a limited liability company etc.'
	_status = models.IntegerProperty(null=True,help_text=u'',verbose_name=u'status')
	...
	office_address = models.StringProperty(null=True,help_text=u'The address or addresses where this organization does business. Do add the country at the end of the address, e.g. Grimmstraße 10A, 10967 Berlin, Germany.',verbose_name=u'Office address')
	address = models.StringProperty(null=True,help_text=u'The official address of the organization.',verbose_name=u'Address')
	_author = models.Relationship(User,null=True,rel_type='company_company_has_admin_author+',help_text=u'People that edited this entity.',verbose_name=u'author')
	revenue = models.Relationship("Revenue",null=True,rel_type='company_has_revenue+',help_text=u'A Revenue represents the quantity of cash that the Organization was able to gather in any given year. It doesn\'t have to be equal to the net sales but can take into account subsidies as well.',verbose_name=u'Revenue')
	adviser = models.Relationship("Person",null=True,rel_type='company_has_adviser+',help_text=u'The list of persons that help the entity.',verbose_name=u'Adviser')
	litigation_against = models.Relationship("self",null=True,rel_type='company_has_litigation_against+',help_text=u'An entity is said to litigate against another when it is involved in a lawsuit or an out-of-court settlement with the other.',verbose_name=u'Litigation against')
	fundraising_round = models.Relationship("FundraisingRound",null=True,rel_type='company_has_fundraising_round+',help_text=u'A Fundraising Round represents an event when an Organization was able to raise cash or another asset.',verbose_name=u'Fundraising round')
	partner = models.Relationship("self",null=True,rel_type='company_has_partner+',help_text=u'An entity can have Partners, i.e. Organizations that help without making a financial contribution (if financial or substancial help is involved, use Fundraising Round instead).',verbose_name=u'Partner')
	board_member = models.Relationship("Person",null=True,rel_type='company_has_board_member+',help_text=u'The list of board members of the Organization, if any.',verbose_name=u'Board member')

	class Meta:
		verbose_name = u'Company'
		verbose_name_plural = u'Companies'

class GovernmentOrganization(models.NodeModel):
	_parent = u'Organization'
	_description = u'A Government Organization is an emanation of a national or local government, such as an Administration, an Authority, a Ministry etc.'
	_status = models.IntegerProperty(null=True,help_text=u'',verbose_name=u'status')
	source = models.URLProperty(null=True,help_text=u'The URL (starting with http://) to your source. If the source is a book, enter the URL to the book at Google Books or Amazon.',verbose_name=u'Source')
	website_url = models.URLProperty(null=True,help_text=u'',verbose_name=u'Website URL')
	name = models.StringProperty(null=True,help_text=u'')
	...
	office_address = models.StringProperty(null=True,help_text=u'The address or addresses where this organization does business. Do add the country at the end of the address, e.g. Grimmstraße 10A, 10967 Berlin, Germany.',verbose_name=u'Office address')
	address = models.StringProperty(null=True,help_text=u'The official address of the organization.',verbose_name=u'Address')
	_author = models.Relationship(User,null=True,rel_type='government_organization_government_organization_has_admin_author+',help_text=u'People that edited this entity.',verbose_name=u'author')
	revenue = models.Relationship("Revenue",null=True,rel_type='government_organization_has_revenue+',help_text=u'A Revenue represents the quantity of cash that the Organization was able to gather in any given year. It doesn\'t have to be equal to the net sales but can take into account subsidies as well.',verbose_name=u'Revenue')
	adviser = models.Relationship("Person",null=True,rel_type='government_organization_has_adviser+',help_text=u'The list of persons that help the entity.',verbose_name=u'Adviser')
	litigation_against = models.Relationship("self",null=True,rel_type='government_organization_has_litigation_against+',help_text=u'An entity is said to litigate against another when it is involved in a lawsuit or an out-of-court settlement with the other.',verbose_name=u'Litigation against')
	fundraising_round = models.Relationship("FundraisingRound",null=True,rel_type='government_organization_has_fundraising_round+',help_text=u'A Fundraising Round represents an event when an Organization was able to raise cash or another asset.',verbose_name=u'Fundraising round')
	partner = models.Relationship("self",null=True,rel_type='government_organization_has_partner+',help_text=u'An entity can have Partners, i.e. Organizations that help without making a financial contribution (if financial or substancial help is involved, use Fundraising Round instead).',verbose_name=u'Partner')
	board_member = models.Relationship("Person",null=True,rel_type='government_organization_has_board_member+',help_text=u'The list of board members of the Organization, if any.',verbose_name=u'Board member')
...
class Product(models.NodeModel):
	...
	image = models.URLProperty(null=True,help_text=u'The URL (starting with http://) where the image is hosted.',verbose_name=u'Image URL')
	source = models.URLProperty(null=True,help_text=u'The URL (starting with http://) to your source. If the source is a book, enter the URL to the book at Google Books or Amazon.',verbose_name=u'Source')
	_author = models.Relationship(User,null=True,rel_type='product_product_has_admin_author+',help_text=u'People that edited this entity.',verbose_name=u'author')
...
class Ngo(models.NodeModel):
	_parent = u'Organization'
	_description = u'A Non-Government Organization is a not-for-profit Organization that can be local or global in scope, usually aiming at fulfilling a goal (ex: Greenpeace, Local Energy Network) or managing an asset (ex: the Bill & Melinda Gates Foundation).'
	_status = models.IntegerProperty(null=True,help_text=u'',verbose_name=u'status')
	source = models.URLProperty(null=True,help_text=u'The URL (starting with http://) to your source. If the source is a book, enter the URL to the book at Google Books or Amazon.',verbose_name=u'Source')
	website_url = models.URLProperty(null=True,help_text=u'',verbose_name=u'Website URL')
	name = models.StringProperty(null=True,help_text=u'')
	...
	office_address = models.StringProperty(null=True,help_text=u'The address or addresses where this organization does business. Do add the country at the end of the address, e.g. Grimmstraße 10A, 10967 Berlin, Germany.',verbose_name=u'Office address')
	address = models.StringProperty(null=True,help_text=u'The official address of the organization.',verbose_name=u'Address')
	_author = models.Relationship(User,null=True,rel_type='ngo_ngo_has_admin_author+',help_text=u'People that edited this entity.',verbose_name=u'author')
	revenue = models.Relationship("Revenue",null=True,rel_type='ngo_has_revenue+',help_text=u'A Revenue represents the quantity of cash that the Organization was able to gather in any given year. It doesn\'t have to be equal to the net sales but can take into account subsidies as well.',verbose_name=u'Revenue')
	adviser = models.Relationship("Person",null=True,rel_type='ngo_has_adviser+',help_text=u'The list of persons that help the entity.',verbose_name=u'Adviser')
	litigation_against = models.Relationship("self",null=True,rel_type='ngo_has_litigation_against+',help_text=u'An entity is said to litigate against another when it is involved in a lawsuit or an out-of-court settlement with the other.',verbose_name=u'Litigation against')
	fundraising_round = models.Relationship("FundraisingRound",null=True,rel_type='ngo_has_fundraising_round+',help_text=u'A Fundraising Round represents an event when an Organization was able to raise cash or another asset.',verbose_name=u'Fundraising round')
	partner = models.Relationship("self",null=True,rel_type='ngo_has_partner+',help_text=u'An entity can have Partners, i.e. Organizations that help without making a financial contribution (if financial or substancial help is involved, use Fundraising Round instead).',verbose_name=u'Partner')
	board_member = models.Relationship("Person",null=True,rel_type='ngo_has_board_member+',help_text=u'The list of board members of the Organization, if any.',verbose_name=u'Board member')
