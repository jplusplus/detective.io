...
urlpatterns = patterns('',
    ...
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/$',                                                      'app.detective.views.home',            name='user'),
    ...
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/(?P<topic>[a-zA-Z0-9_\-]+)/(?P<type>\w+)/(?P<pk>\d+)/$', 'app.detective.views.entity',          name='single'),
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/(?P<topic>[a-zA-Z0-9_\-]+)/contribute/$',                'app.detective.views.home',            name='contribute'),
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/(?P<topic>[a-zA-Z0-9_\-]+)/invite/$',                    'app.detective.views.home',            name='invite'),
