...
urlpatterns = patterns('',
    ...
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/$',                                                      'app.detective.views.profile',         name='user'),
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/new-topic/$',                                            'app.detective.views.profile',         name='topic-create'),
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/(?P<topic>[a-zA-Z0-9_\-]+)/$',                           'app.detective.views.topic',           name='explore'),
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/(?P<topic>[a-zA-Z0-9_\-]+)/graph/$',                     'app.detective.views.topic',           name='explore'),
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/(?P<topic>[a-zA-Z0-9_\-]+)/(?P<type>\w+)/$',             'app.detective.views.entity_list',     name='list'),
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/(?P<topic>[a-zA-Z0-9_\-]+)/(?P<type>\w+)/(?P<pk>\d+)/$', 'app.detective.views.entity_details',  name='single'),
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/(?P<topic>[a-zA-Z0-9_\-]+)/contribute/$',                'app.detective.views.topic',           name='contribute'),
    url(r'^(?P<user>[a-zA-Z0-9_\-\.]+)/(?P<topic>[a-zA-Z0-9_\-]+)/invite/$',                    'app.detective.views.topic',           name='invite'),
