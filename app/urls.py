...
urlpatterns = patterns('',
    ...
    url(r'^(?P<user>[\w\-\.]+)/(?P<topic>[\w\-]+)/settings/$', 'app.detective.views.topic', name='topic-settings'),
    url(r'^(?P<user>[\w\-\.]+)/(?P<topic>[\w\-]+)/settings/structure/$', 'app.detective.views.topic', name='topic-settings'),
